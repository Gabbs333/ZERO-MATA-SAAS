-- Migration: Fix process_retour function - use 'stocks' table instead of 'stock'
-- Description: Corrects the table name in the stock update query
-- Created: 2026-04-02

-- Drop the existing function
DROP FUNCTION IF EXISTS process_retour(UUID, UUID, JSONB, TEXT, UUID);

-- Recreate with corrected table name
