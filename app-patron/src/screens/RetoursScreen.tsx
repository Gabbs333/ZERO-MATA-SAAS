...
import { ArrowLeft, Package, Receipt, Search, X, CheckCircle, AlertCircle } from 'lucide-react';
import type { Facture, CommandeItem, Retour } from '../types/database.types';
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-neutral-500 dark:text-neutral-400 text-sm">
              Gérez les retours sur les commandes validées
            </p>
          </div>
        </div>
